...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Portfólio de Alex Santos: desenvolvedor fullstack criando arquiteturas de código limpo e escalável." },
      { name: "author", content: "Alex Santos" },
      { property: "og:title", content: "Alex Santos — Desenvolvedor Fullstack" },
      { property: "og:description", content: "Arquiteturas de código limpo e escalável. Projetos, stack e contato." },
